# You are given an integer array prices where prices[i] is the price of stock on the ith day. You may choose a single day to buy one stock and choose a different day in the future to sell it.Return the maximum profit you can achieve.
